...
> If you create overlay transformations using the Python SDK, you can migrate to the new Layers syntax using the `raw` transformation parameter, as given in the example below.
