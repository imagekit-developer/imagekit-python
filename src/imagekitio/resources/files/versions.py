...
class VersionsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            path_template("/v1/files/{file_id}/versions", file_id=file_id),
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            path_template("/v1/files/{file_id}/versions/{version_id}", file_id=file_id, version_id=version_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def restore(
        ...
        *,
        ...
        if not version_id:
            raise ValueError(f"Expected a non-empty value for `version_id` but received {version_id!r}")
        return self._put(
            path_template("/v1/files/{file_id}/versions/{version_id}/restore", file_id=file_id, version_id=version_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=File,
