...
__all__ = ["FileVersionDeletedWebhookEvent", "FileVersionDeletedWebhookEventData"]


class FileVersionDeletedWebhookEventData(BaseModel):
...
class FileVersionDeletedWebhookEvent(BaseWebhookEvent):
