...
class GetImageAttributesOptions(SrcOptions, total=False):
    """
    ...
    device_breakpoints: Annotated[Iterable[float], PropertyInfo(alias="deviceBreakpoints")]
    """
    ...
    image_breakpoints: Annotated[Iterable[float], PropertyInfo(alias="imageBreakpoints")]
    """
