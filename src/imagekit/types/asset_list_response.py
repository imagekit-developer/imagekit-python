...
__all__ = [
    "AssetListResponse",
    "AssetListResponseItem",
    "AssetListResponseItemFileDetails",
    "AssetListResponseItemFileDetailsAITag",
    "AssetListResponseItemFileDetailsVersionInfo",
    "AssetListResponseItemFolderDetails",
]


class AssetListResponseItemFileDetailsAITag(BaseModel):
...
class AssetListResponseItemFileDetailsVersionInfo(BaseModel):
...
class AssetListResponseItemFileDetails(BaseModel):
    ...
    version_info: Optional[AssetListResponseItemFileDetailsVersionInfo] = FieldInfo(alias="versionInfo", default=None)
...
AssetListResponseItem: TypeAlias = Union[AssetListResponseItemFileDetails, AssetListResponseItemFolderDetails]
