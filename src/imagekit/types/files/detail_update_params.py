...
UpdateFileDetailsExtension: TypeAlias = Union[
    UpdateFileDetailsExtensionRemovedotBgExtension, UpdateFileDetailsExtensionAutoTaggingExtension
]
...
DetailUpdateParams: TypeAlias = Union[UpdateFileDetails, ChangePublicationStatus]
