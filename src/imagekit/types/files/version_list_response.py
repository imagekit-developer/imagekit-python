...
__all__ = [
    "VersionListResponse",
    "VersionListResponseItem",
    "VersionListResponseItemAITag",
    "VersionListResponseItemVersionInfo",
]


class VersionListResponseItemAITag(BaseModel):
...
class VersionListResponseItemVersionInfo(BaseModel):
...
class VersionListResponseItem(BaseModel):
    ai_tags: Optional[List[VersionListResponseItemAITag]] = FieldInfo(alias="AITags", default=None)
    ...
    version_info: Optional[VersionListResponseItemVersionInfo] = FieldInfo(alias="versionInfo", default=None)
