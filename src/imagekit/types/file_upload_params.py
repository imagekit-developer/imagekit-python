...
__all__ = [
    ...
    "FileUploadV1ByURL",
    "FileUploadV1ByURLExtension",
    "FileUploadV1ByURLExtensionRemoveBg",
    "FileUploadV1ByURLExtensionRemoveBgOptions",
    "FileUploadV1ByURLExtensionAutoTaggingExtension",
    "FileUploadV1ByURLExtensionAIAutoDescription",
    "FileUploadV1ByURLTransformation",
    "FileUploadV1ByURLTransformationPost",
    "FileUploadV1ByURLTransformationPostTransformation",
    "FileUploadV1ByURLTransformationPostGifToVideo",
    "FileUploadV1ByURLTransformationPostThumbnail",
    "FileUploadV1ByURLTransformationPostAbs",
]
...
class FileUploadV1ByURL(TypedDict, total=False):
    file: Required[str]
    """A publicly reachable URL that ImageKit’s servers can fetch.

    The server must receive the response headers within 8 seconds; otherwise the
    ...
    **Note**: Sending a value that has been used in the past will result in a
    ...
    extensions: Iterable[FileUploadV1ByURLExtension]
    """Array of extensions to be applied to the image.
    ...
    transformation: FileUploadV1ByURLTransformation
    """Configure pre-processing (`pre`) and post-processing (`post`) transformations.
...
class FileUploadV1ByURLExtensionRemoveBgOptions(TypedDict, total=False):
    add_shadow: bool
    """Whether to add an artificial shadow to the result.
...
class FileUploadV1ByURLExtensionRemoveBg(TypedDict, total=False):
    name: Required[Literal["remove-bg"]]
    """Specifies the background removal extension."""

    options: FileUploadV1ByURLExtensionRemoveBgOptions


class FileUploadV1ByURLExtensionAutoTaggingExtension(TypedDict, total=False):
    max_tags: Required[Annotated[int, PropertyInfo(alias="maxTags")]]
    """Maximum number of tags to attach to the asset."""
...
class FileUploadV1ByURLExtensionAIAutoDescription(TypedDict, total=False):
    name: Required[Literal["ai-auto-description"]]
    """Specifies the auto description extension."""


FileUploadV1ByURLExtension: TypeAlias = Union[
    FileUploadV1ByURLExtensionRemoveBg,
    FileUploadV1ByURLExtensionAutoTaggingExtension,
    FileUploadV1ByURLExtensionAIAutoDescription,
]
...
class FileUploadV1ByURLTransformationPostTransformation(TypedDict, total=False):
    type: Required[Literal["transformation"]]
    """Transformation type."""
...
class FileUploadV1ByURLTransformationPostGifToVideo(TypedDict, total=False):
    type: Required[Literal["gif-to-video"]]
    """Converts an animated GIF into an MP4."""
...
class FileUploadV1ByURLTransformationPostThumbnail(TypedDict, total=False):
    type: Required[Literal["thumbnail"]]
    """Generates a thumbnail image."""
...
class FileUploadV1ByURLTransformationPostAbs(TypedDict, total=False):
    protocol: Required[Literal["hls", "dash"]]
    """Streaming protocol to use (`hls` or `dash`)."""
...
FileUploadV1ByURLTransformationPost: TypeAlias = Union[
    FileUploadV1ByURLTransformationPostTransformation,
    FileUploadV1ByURLTransformationPostGifToVideo,
    FileUploadV1ByURLTransformationPostThumbnail,
    FileUploadV1ByURLTransformationPostAbs,
...
class FileUploadV1ByURLTransformation(TypedDict, total=False):
    post: Iterable[FileUploadV1ByURLTransformationPost]
    """List of transformations to apply _after_ the file is uploaded.
...
FileUploadParams: TypeAlias = Union[FileUploadV1, FileUploadV1ByURL]
