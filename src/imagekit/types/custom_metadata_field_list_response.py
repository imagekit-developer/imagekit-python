...
__all__ = [
    ...
    "CustomMetadataFieldListResponseItem",
    "CustomMetadataFieldListResponseItemSchema",
]
...
class CustomMetadataFieldListResponseItem(BaseModel):
    id: str
    ...
    schema_: CustomMetadataFieldListResponseItemSchema = FieldInfo(alias="schema")
    """An object that describes the rules for the custom metadata field value."""


CustomMetadataFieldListResponse: TypeAlias = List[CustomMetadataFieldListResponseItem]
