...
__all__ = ["FileListResponse", "FileListResponseItem", "FileListResponseItemAITag", "FileListResponseItemVersionInfo"]


class FileListResponseItemAITag(BaseModel):
...
class FileListResponseItemVersionInfo(BaseModel):
...
class FileListResponseItem(BaseModel):
    ai_tags: Optional[List[FileListResponseItemAITag]] = FieldInfo(alias="AITags", default=None)
    ...
    version_info: Optional[FileListResponseItemVersionInfo] = FieldInfo(alias="versionInfo", default=None)
