...
class URLEndpointListResponseItem(BaseModel):
    id: str
    ...
    url_rewriter: Optional[URLEndpointListResponseItemURLRewriter] = FieldInfo(alias="urlRewriter", default=None)
    """Configuration for third-party URL rewriting."""


URLEndpointListResponse: TypeAlias = List[URLEndpointListResponseItem]
