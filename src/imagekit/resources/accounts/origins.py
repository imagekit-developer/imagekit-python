...
class OriginsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: origin_create_params.Body,
        ...
        return cast(
            ...
            self._post(
                "/v1/accounts/origins",
                body=maybe_transform(body, origin_create_params.OriginCreateParams),
    ...
    def update(
        ...
        id: str,
        *,
        body: origin_update_params.Body,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return cast(
            ...
            self._put(
                ...
                body=maybe_transform(body, origin_update_params.OriginUpdateParams),
                options=make_request_options(
                    extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
                ),
                cast_to=cast(
    ...
    async def create(
        ...
        *,
        ...
        return cast(
            ...
            await self._post(
                "/v1/accounts/origins",
                body=await async_maybe_transform(body, origin_create_params.OriginCreateParams),
                options=make_request_options(
                    extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
                ),
                cast_to=cast(
    ...
    async def update(
        ...
        *,
        ...
        return cast(
            ...
            await self._put(
                f"/v1/accounts/origins/{id}",
                body=await async_maybe_transform(body, origin_update_params.OriginUpdateParams),
                options=make_request_options(
                    extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
                ),
                cast_to=cast(
