...
- <code title="delete /v1/named-transformations/{id}">client.named_transformations.<a href="./src/imagekitio/resources/named_transformations.py">delete</a>(id) -> None</code>
