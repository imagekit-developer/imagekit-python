...
class MetadataExif:
    ...
    def __init__(self, image: MetadataExifImage = None, thumbnail: MetadataExifThumbnail = None,
                 exif: MetadataExifExif = None,
                 gps: MetadataExifGPS = None, interoperability: MetadataExifInteroperability = None, makernote=None):
        if makernote is None:
            makernote = {}
        if image is None or image == {}:
            self.image = MetadataExifImage(None, None, None, None, None, None, None, None, None, None, None)
        else:
            if type(image) == MetadataExifImage:
                self.image = image
            else:
                self.image = MetadataExifImage(image['Make'] if 'Make' in image else None,
        ...
        if thumbnail is None or thumbnail == {}:
            ...
            if type(thumbnail) == MetadataExifThumbnail:
                ...
                self.thumbnail = MetadataExifThumbnail(thumbnail['Compression'] if 'Compression' in thumbnail else None,
                                                       thumbnail['XResolution'] if 'XResolution' in thumbnail else None,
                                                       thumbnail['YResolution'] if 'YResolution' in thumbnail else None,
                                                       thumbnail[
                                                           'ResolutionUnit'] if 'ResolutionUnit' in thumbnail else None,
                                                       thumbnail[
                                                           'ThumbnailOffset'] if 'ThumbnailOffset' in thumbnail else None,
                                                       thumbnail[
                                                           'ThumbnailLength'] if 'ThumbnailLength' in thumbnail else None
                                                       )
        if exif is None or exif == {}:
            self.exif = MetadataExifExif(None, None, None, None, None, None, None, None, None, None, None, None, None,
            ...
            if type(exif) == MetadataExifExif:
                ...
                self.exif = MetadataExifExif(exif['ExposureTime'] if 'ExposureTime' in exif else None,
                                             ...
                                             exif['ExposureCompensation'] if 'ExposureCompensation' in exif else None,
                                             ...
                                             exif['SubSecTimeOriginal'] if 'SubSecTimeOriginal' in exif else None,
                                             exif['SubSecTimeDigitized'] if 'SubSecTimeDigitized' in exif else None,
                                             ...
                                             exif['FocalPlaneXResolution'] if 'FocalPlaneXResolution' in exif else None,
                                             exif['FocalPlaneYResolution'] if 'FocalPlaneYResolution' in exif else None,
                                             exif[
                                                 'FocalPlaneResolutionUnit'] if 'FocalPlaneResolutionUnit' in exif else None,
        ...
        if gps is None or gps == {}:
            ...
            if type(gps) == MetadataExifGPS:
                ...
                self.gps = MetadataExifGPS(gps['GPSVersionID'] if 'GPSVersionID' in gps else None)
        ...
        if interoperability is None or interoperability == {}:
            ...
            if type(interoperability) == MetadataExifInteroperability:
                ...
                self.interoperability = MetadataExifInteroperability(
                    interoperability['InteropIndex'] if 'InteropIndex' in interoperability else None,
                    interoperability['InteropVersion'] if 'InteropVersion' in interoperability else None)
