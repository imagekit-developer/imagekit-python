...
class ImageKit(object):
    ...
    def restore_file_version(self, file_id, version_id) -> FileResultWithResponseMetadata:
    ...
    def get_purge_cache_status(self, purge_cache_id: str = "") -> PurgeCacheStatusResult:
        """Get Purge Cache status by purge cache request_id
        """
        return self.file.get_purge_cache_status(str(purge_cache_id))

    def get_purge_file_cache_status(self, purge_cache_id: str = "") -> PurgeCacheStatusResult:
        """Get Purge Cache status by purge cache request_id
        """
        return self.file.get_purge_cache_status(str(purge_cache_id))
    ...
    def get_remote_file_url_metadata(self, remote_file_url: str = "") -> GetMetadataResult:
    ...
    def get_custom_metadata_fields(self, include_deleted: bool = False) -> ListCustomMetadataFieldsResult:
