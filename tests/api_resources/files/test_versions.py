...
from imagekit.types.files import VersionListResponse, VersionRestoreResponse, VersionRetrieveResponse
...
class TestVersions:
    ...
    def test_method_retrieve(self, client: ImageKit) -> None:
        version = client.files.versions.retrieve(
    ...
    def test_raw_response_retrieve(self, client: ImageKit) -> None:
        response = client.files.versions.with_raw_response.retrieve(
            version_id="versionId",
            file_id="fileId",
        )
    ...
    def test_streaming_response_retrieve(self, client: ImageKit) -> None:
        with client.files.versions.with_streaming_response.retrieve(
            version_id="versionId",
            file_id="fileId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: ImageKit) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `file_id` but received ''"):
            client.files.versions.with_raw_response.retrieve(
                version_id="versionId",
                file_id="",
            )
    ...
    def test_method_restore(self, client: ImageKit) -> None:
        ...
        assert_matches_type(VersionRestoreResponse, version, path=["response"])
...
class TestAsyncVersions:
    ...
    async def test_method_retrieve(self, async_client: AsyncImageKit) -> None:
        version = await async_client.files.versions.retrieve(
            version_id="versionId",
            file_id="fileId",
        )
        assert_matches_type(VersionRetrieveResponse, version, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncImageKit) -> None:
        response = await async_client.files.versions.with_raw_response.retrieve(
            version_id="versionId",
            file_id="fileId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncImageKit) -> None:
        async with async_client.files.versions.with_streaming_response.retrieve(
            version_id="versionId",
            file_id="fileId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncImageKit) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `file_id` but received ''"):
            await async_client.files.versions.with_raw_response.retrieve(
                version_id="versionId",
                file_id="",
            )
