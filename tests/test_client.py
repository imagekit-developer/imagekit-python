...
class TestImageKit:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: ImageKit) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.files.with_streaming_response.upload_v1(
                file="https://www.example.com/rest-of-the-image-path.jpg", file_name="fileName"
            ).__enter__()
...
class TestAsyncImageKit:
    ...
    def test_base_url_trailing_slash(self, client: AsyncImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.files.with_streaming_response.upload_v1(
                file="https://www.example.com/rest-of-the-image-path.jpg", file_name="fileName"
            ).__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.files.with_raw_response.upload_v1(
            file="https://www.example.com/rest-of-the-image-path.jpg", file_name="fileName"
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from imagekit._base_client import get_platform
