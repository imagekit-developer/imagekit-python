...
from imagekitio._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
...
class TestImageKit:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: ImageKit) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: ImageKit) -> None:
    ...
    def test_copy(self, client: ImageKit) -> None:
        copied = client.copy()
        assert id(copied) != id(client)

        copied = client.copy(private_key="another My Private Key")
        assert copied.private_key == "another My Private Key"
        assert client.private_key == "My Private Key"

    def test_copy_default_options(self, client: ImageKit) -> None:
    ...
    def test_copy_default_query(self) -> None:
        client = ImageKit(
            base_url=base_url, private_key=private_key, _strict_response_validation=True, default_query={"foo": "bar"}
        )
    ...
    def test_copy_signature(self, client: ImageKit) -> None:
    ...
    def test_copy_build_request(self, client: ImageKit) -> None:
    ...
    def test_request_timeout(self, client: ImageKit) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_client_timeout_option(self) -> None:
        client = ImageKit(
            base_url=base_url, private_key=private_key, _strict_response_validation=True, timeout=httpx.Timeout(0)
        )
    ...
    def test_http_client_timeout_option(self) -> None:
        ...
        with httpx.Client(timeout=None) as http_client:
            client = ImageKit(
                base_url=base_url, private_key=private_key, _strict_response_validation=True, http_client=http_client
            )
    ...
    def test_request_extra_headers(self, client: ImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: ImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: ImageKit) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: ImageKit) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_non_application_json_content_type_for_json_data(self, respx_mock: MockRouter, client: ImageKit) -> None:
        """
    ...
    def test_base_url_setter(self) -> None:
        client = ImageKit(
            base_url="https://example.com/from_init", private_key=private_key, _strict_response_validation=True
        )
    ...
    def test_base_url_env(self) -> None:
        with update_env(IMAGE_KIT_BASE_URL="http://localhost:5000/from/env"):
            client = ImageKit(private_key=private_key, _strict_response_validation=True)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ImageKit(
                base_url="http://localhost:5000/custom/path/", private_key=private_key, _strict_response_validation=True
            ),
            ImageKit(
    ...
    def test_base_url_trailing_slash(self, client: ImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: ImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: ImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = ImageKit(base_url=base_url, private_key=private_key, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: ImageKit) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = ImageKit(base_url=base_url, private_key=private_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        non_strict_client = ImageKit(base_url=base_url, private_key=private_key, _strict_response_validation=False)
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: ImageKit
    ) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: ImageKit) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: ImageKit) -> None:
...
class TestAsyncImageKit:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncImageKit) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncImageKit) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncImageKit) -> None:
        copied = async_client.copy()
        assert id(copied) != id(async_client)

        copied = async_client.copy(private_key="another My Private Key")
        assert copied.private_key == "another My Private Key"
        assert async_client.private_key == "My Private Key"

    def test_copy_default_options(self, async_client: AsyncImageKit) -> None:
        # options that have a default are overridden correctly
    ...
    def test_copy_signature(self, async_client: AsyncImageKit) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncImageKit) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncImageKit) -> None:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncImageKit) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_union_response_different_types(self, respx_mock: MockRouter, async_client: AsyncImageKit) -> None:
        """Union of objects with the same field name using a different type"""
    ...
    async def test_base_url_env(self) -> None:
        with update_env(IMAGE_KIT_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncImageKit(private_key=private_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_base_url_trailing_slash(self, client: AsyncImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncImageKit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncImageKit(base_url=base_url, private_key=private_key, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_client_response_validation_error(self, respx_mock: MockRouter, async_client: AsyncImageKit) -> None:
        class Model(BaseModel):
            foo: str
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncImageKit(base_url=base_url, private_key=private_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        non_strict_client = AsyncImageKit(base_url=base_url, private_key=private_key, _strict_response_validation=False)
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncImageKit
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncImageKit) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncImageKit) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
